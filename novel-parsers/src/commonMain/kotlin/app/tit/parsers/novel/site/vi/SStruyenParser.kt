...
@NovelSourceParser("SSTRUYEN", "SStruyen", "vi")
class SStruyenParser(
    private val context: LoaderContext
) : NovelParser {

    override val id: String = "SSTRUYEN"
    override val name: String = "SStruyen"
    ...
    override suspend fun getDetails(novelUrl: String): ContentDetails {
        ...
        linksToUse.forEach { a ->
            ...
            val chUrl = if (rawHref.startsWith("http")) rawHref else "$base$rawHref"
